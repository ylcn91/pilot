...
func TestCoreLens_CoverageWhenRequested(t *testing.T) {
	l, _ := LensByName(CoreLensName)
	got := l.Collectors(ScanOptions{MinCoverage: 80})
...
func TestRegisterLens_RejectsDuplicate(t *testing.T) {
	...
	RegisterLens(Lens{Name: CoreLensName, Collectors: func(ScanOptions) []Collector { return nil }})
}
...
func TestRegisterLens_RejectsEmptyName(t *testing.T) {
	...
	RegisterLens(Lens{Name: "  ", Collectors: func(ScanOptions) []Collector { return nil }})
}
